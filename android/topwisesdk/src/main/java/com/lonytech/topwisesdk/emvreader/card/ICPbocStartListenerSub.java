...
import com.lonytech.topwisesdk.emvreader.util.DukptHelper;
...
import com.lonytech.topwisesdk.emvreader.util.EncryptionKt;
        ...
        *//*byte[] sendData = PosApplication.getApp().mConsumeData.getICData();
        ...
        cardReadResult.setPinBlockDUKPT(
                DukptHelper.INSTANCE.DesEncryptDukpt(
                        DukptHelper.INSTANCE.getSessionKey(EncryptionKt.IPEK_LIVE, EncryptionKt.KSN_LIVE)
