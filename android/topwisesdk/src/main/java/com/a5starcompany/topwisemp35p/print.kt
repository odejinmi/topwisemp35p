...
//        )
        val base64String: String = call["base64image"]!!
        ...
        val marchantname: String = call["marchantname"]!!
        template.add(
            TextUnit(
                marchantname,
                TextUnit.TextSize.SMALL,
        ...
        val marchantaddress: String = call["marchantaddress"]!!
        template.add(
            TextUnit(
                marchantaddress,
                TextUnit.TextSize.SMALL,
        ...
        val transactiontype = call["transactiontype"]!!
        template.add(
            TextUnit(
                transactiontype,
                TextUnit.TextSize.SMALL,
        ...
        val amount = call["amount"]!!.toDouble() // Convert to Double for formatting
        ...
        val terminalid = call.get("terminalid")!!
        template.add(
            1,
    ...
    fun starteodPrint(call: Map<String, String?>) {
...
//            R.mipmap.ic_launcher
//        )ham@gmail.com
        val base64String: String = call.get("base64image")!!
        val decodedBytes = Base64.decode(base64String, Base64.DEFAULT)
        val bitmap = BitmapFactory.decodeByteArray(decodedBytes, 0, decodedBytes.size)
        ...
        val marchantname: String = call.get("marchantname")!!
        template.add(
            TextUnit(
                marchantname,
                TextUnit.TextSize.SMALL,
        ...
        val marchantaddress: String = call.get("marchantaddress")!!
        template.add(
            TextUnit(
                marchantaddress,
                TextUnit.TextSize.SMALL,
...
//        }
        ...
        val totalapproved = call.get("totalapproved")!!
        template.add(
            1,
        ...
        val totalfailed = call.get("totalfailed")!!
        template.add(
            1,
        ...
        val totalcredit = call.get("totalcredit")!!
        template.add(
            1,
        ...
        val totaldebit = call.get("totaldebit")!!
        template.add(
            1,
    ...
    fun startCustomPrint(call: Map<String, String?>) {

        val marchantname = call.get("textprint")
