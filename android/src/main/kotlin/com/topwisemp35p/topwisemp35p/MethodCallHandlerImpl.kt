package com.a5starcompany.topwise
...
import com.topwise.library.TopWiseDevice
import com.topwise.library.util.emv.DeviceState
import android.util.Base64
import android.util.Log
import androidx.lifecycle.lifecycleScope
import com.example.paylony_pos.Datum
import com.example.paylony_pos.Printmodel
import com.example.paylony_pos.TargetActivity
import com.paylony.topwise.emvreader.CardReaderImpl
import com.paylony.topwise.emvreader.emv.CardReadState
import com.paylony.topwise.emvreader.printer.Align
import com.paylony.topwise.emvreader.printer.ImageUnit
import com.paylony.topwise.emvreader.printer.TextUnit
import com.paylony.topwise.emvreader.printer.PrintTemplate
import com.stackonstack.utils.Utils
...
//            }
            ...
            "debitcard" -> {
//                        var intent = Intent(binding.activity, TargetActivity::class.java)
                readCard(call)
//                        makePayment(call)
...
//                        startActivityForResult(intent, 100)
            ...
            "serialnumber" -> {
                ...
                map["state"] = "1"
                map["message"] = Utils.serialnumber
                map["status"] = true
                result.success(Utils.serialnumber)
            }
        ...
        TopWiseDevice(binding.activity) {
            when (it.state) {
                DeviceState.INSERT_CARD -> {
                    Log.e("tolu result", "the result i get")
//                    val map: MutableMap<String, Any> = mutableMapOf()
//                    val map1: MutableMap<String, Any> = mutableMapOf()
//                    val transactionData = it.transactionData
//                    map1["pan"] = transactionData?.pan!!
//                    map1["stan"] = transactionData.stan
//                    map1["rrn"] = transactionData.rrn
//                    map1["pinBlock"] = transactionData.pinBlock!!
//                    map1["iccData"] = transactionData.iccData
//                    map1["track2Data"] = transactionData.track2Data
//                    map1["postDataCode"] = transactionData.postDataCode
//                    map1["cardExpiryDate"] = transactionData.cardExpiryDate
//                    map1["acceptorCode"] = transactionData.acceptorCode
//                    map1["sequenceNumber"] = transactionData.sequenceNumber
//                    map1["serviceCode"] = transactionData.serviceCode
//                    map1["transactionCode"] = transactionData.transactionCode
//                    map1["terminalId"] = transactionData.terminalId
//                    map1["merchantName"] = transactionData.merchantName
//                    map1["customerName"] = transactionData.customerName!!
//                    map1["acquiringInstitutionalCode"] = transactionData.acquiringInstitutionalCode
//                    map1["amount"] = transactionData.amount.toString()
//                    map1["accountType"] = transactionData.accountType.toString()
//
//                    map["state"] = it.state.toString()
//                    map["message"] = it.message
//                    map["status"] = it.status
//                    map["transactionData"] = map1
//                    Log.e("tolulope12", map.toString())
//
//                    result?.success(map)
                }
                ...
                DeviceState.INFO -> {
                    Log.e("tolu result is here", "the result i get")
                    val map: MutableMap<String, Any> = mutableMapOf()
                    val map1: MutableMap<String, Any> = mutableMapOf()
                    val transactionData = it.transactionData
                    map1["pan"] = transactionData?.pan!!
    ...
    fun readCard(call: MethodCall) {

        var intent = Intent(binding.activity, TargetActivity::class.java)
        val amount = call.argument<String>("amount")!!
        intent.putExtra("amount", amount)
        binding.activity.startActivityForResult(intent, 100)

//        val amount = call.argument<String>("amount")!!
//        lifecycleScope.launch {
//            val cardManager = CardReaderImpl(binding.activity)
...
////            ).show()
////////                        val intent = Intent()
////////                        intent.setClass(binding.activity, PinpadActivity3::class.java)
////////
