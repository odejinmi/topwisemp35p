...
public class Aid extends BaseModel {
    ...
    @Column(
            name = "rdClssFloorLimitFlg"
    )
    private boolean rdClssFloorLimitFlg = false;
    @Column(
            name = "rdClssFloorLimit"
    )
    ...
    public void fromTlvList(TlvList tlvList) {
        String TAG = "Aid,fromTlvList";
        Tlv tlv = tlvList.getTlv("9F06");
        if (tlv != null) {
            this.setAid(tlv.getHexValue());
            Log.d("Aid,fromTlvList", "9F06: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF01");
        if (tlv != null) {
            this.setSelFlag(tlv.getValue()[0]);
            Log.d("Aid,fromTlvList", "DF01: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF17");
        if (tlv != null) {
            this.setTargetPer(tlv.getValue()[0]);
            Log.d("Aid,fromTlvList", "DF17: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF16");
        if (tlv != null) {
            this.setMaxTargetPer(tlv.getValue()[0]);
            Log.d("Aid,fromTlvList", "DF16: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F1B");
        if (tlv != null) {
            this.setFloorLimit(BytesUtil.bytes2Int(tlv.getValue(), true));
            Log.d("Aid,fromTlvList", "9F1B: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF19");
        int value;
        if (tlv != null) {
            Log.d("Aid,fromTlvList", "DF19: " + tlv.getHexValue());
            value = Integer.valueOf(tlv.getHexValue());
            Log.d("Aid,fromTlvList", "DF19 INT: " + value);
            this.setRdClssFloorLimit(value);
        }

        tlv = tlvList.getTlv("DF20");
        if (tlv != null) {
            Log.d("Aid,fromTlvList", "DF20: " + tlv.getHexValue());
            value = Integer.valueOf(tlv.getHexValue());
            Log.d("Aid,fromTlvList", "DF20 INT: " + value);
            this.setRdClssTxnLimit(value);
        }

        tlv = tlvList.getTlv("DF21");
        if (tlv != null) {
            Log.d("Aid,fromTlvList", "DF21: " + tlv.getHexValue());
            value = Integer.valueOf(tlv.getHexValue());
            Log.d("Aid,fromTlvList", "DF21 INT: " + value);
            this.setRdCVMLimit(value);
        }

        tlv = tlvList.getTlv("DF15");
        if (tlv != null) {
            this.setThreShold(BytesUtil.bytes2Int(tlv.getValue(), true));
            Log.d("Aid,fromTlvList", "DF15: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF13");
        if (tlv != null) {
            this.setTacDenial(tlv.getValue());
            Log.d("Aid,fromTlvList", "DF13: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF12");
        if (tlv != null) {
            this.setTacOnline(tlv.getValue());
            Log.d("Aid,fromTlvList", "DF12: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF11");
        if (tlv != null) {
            this.setTacDefault(tlv.getValue());
            Log.d("Aid,fromTlvList", "DF11: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F01");
        if (tlv != null) {
            this.setAcquierId(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F01: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF14");
        if (tlv != null) {
            this.setdDol(tlv.getValue());
            Log.d("Aid,fromTlvList", "DF14: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF8102");
        if (tlv != null) {
            this.settDol(tlv.getValue());
            Log.d("Aid,fromTlvList", "DF8102: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F08");
        if (tlv != null) {
            this.setVersion(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F08: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F09");
        if (tlv != null) {
            this.setVersion(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F09: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F1D");
        if (tlv != null) {
            this.setRiskManData(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F1D: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F4E");
        if (tlv != null) {
            this.setMerchName(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F4E: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F15");
        if (tlv != null) {
            this.setMerchCateCode(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F15: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F16");
        if (tlv != null) {
            this.setMerchId(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F16: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F1C");
        if (tlv != null) {
            this.setTermId(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F1C: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("5F2A");
        if (tlv != null) {
            this.setTransCurrCode(tlv.getValue());
            Log.d("Aid,fromTlvList", "5F2A: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("5F36");
        if (tlv != null) {
            this.setTransCurrExp(tlv.getValue()[0]);
            Log.d("Aid,fromTlvList", "5F36: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F3C");
        if (tlv != null) {
            this.setReferCurrCode(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F3C: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F3D");
        if (tlv != null) {
            this.setReferCurrExp(tlv.getValue()[0]);
            Log.d("Aid,fromTlvList", "9F3D: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("DF8101");
        if (tlv != null) {
            this.setReferCurrCon(BytesUtil.bytes2Int(tlv.getValue(), true));
            Log.d("Aid,fromTlvList", "DF8101: " + tlv.getHexValue());
        }

        tlv = tlvList.getTlv("9F7B");
        if (tlv != null) {
            this.setEcTtl(tlv.getValue());
            Log.d("Aid,fromTlvList", "9F7B: " + tlv.getHexValue());
        }

    }

    public TlvList getTlvList() {
        String TAG = "Aid,getTlvList";
        TlvList tlvList = new TlvList();
        tlvList.addTlv("9F06", this.aid);
        tlvList.addTlv("DF01", new byte[]{this.selFlag});
        tlvList.addTlv("DF17", new byte[]{this.targetPer});
        tlvList.addTlv("DF16", new byte[]{this.maxTargetPer});
        tlvList.addTlv("9F1B", BytesUtil.int2Bytes(this.floorLimit, true));
        tlvList.addTlv("DF19", BytesUtil.hexString2Bytes(String.format("%012d", this.rdClssFloorLimit)));
        tlvList.addTlv("DF20", BytesUtil.hexString2Bytes(String.format("%012d", this.rdClssTxnLimit)));
        tlvList.addTlv("DF21", BytesUtil.hexString2Bytes(String.format("%012d", this.rdCVMLimit)));
        tlvList.addTlv("DF15", BytesUtil.int2Bytes(this.threShold, true));
        tlvList.addTlv("DF13", this.tacDenial);
        tlvList.addTlv("DF12", this.tacOnline);
        tlvList.addTlv("DF11", this.tacDefault);
        tlvList.addTlv("9F01", this.acquierId);
        tlvList.addTlv("DF14", this.dDol);
        tlvList.addTlv("DF8102", this.tDol);
        tlvList.addTlv("9F09", this.version);
        tlvList.addTlv("9F1D", this.riskManData);
        tlvList.addTlv("9F4E", this.merchName);
        tlvList.addTlv("9F15", this.merchCateCode);
        tlvList.addTlv("9F16", this.merchId);
        tlvList.addTlv("9F1C", this.termId);
        tlvList.addTlv("5F2A", this.transCurrCode);
        tlvList.addTlv("5F36", new byte[]{this.transCurrExp});
        tlvList.addTlv("9F3C", this.referCurrCode);
        tlvList.addTlv("9F3D", new byte[]{this.referCurrExp});
        tlvList.addTlv("DF8101", BytesUtil.int2Bytes(this.referCurrCon, true));
        tlvList.addTlv("9F7B", this.ecTtl);
        return tlvList;
    }
