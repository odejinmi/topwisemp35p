...
import com.paylony.topwise.emvreader.card.CardManager.CardExceptionCallBack
import  com.paylony.charackterEncoder.BCDASCII
import  com.paylony.topwise.emvreader.util.CardSearchErrorUtil
...
//            finish()
    ...
    companion object {
        private val TAG = Utils.TAGPUBLIC + PinpadActivity::class.java.simpleName
    }
}