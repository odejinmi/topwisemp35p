...
import static com.paylony.topwise.emvreader.util.EncryptionKt.IPEK_LIVE;
import static com.paylony.topwise.emvreader.util.EncryptionKt.KSN_LIVE;

import android.content.*;
import android.os.*;
import android.util.*;
import com.paylony.charackterEncoder.BCDASCII;
import com.paylony.topwise.emvreader.emv.*;
import com.paylony.topwise.emvreader.util.*;
import com.paylony.topwise.emvreader.Utils;
import com.paylony.topwise.emvreader.activity.PinpadActivity;
...
import com.paylony.topwise.emvreader.util.DukptHelper;
...
public class ICPbocStartListenerSub implements OnEmvProcessListener {
    ...
    public ICPbocStartListenerSub(Context context) throws RemoteException {
        mContext = context;
